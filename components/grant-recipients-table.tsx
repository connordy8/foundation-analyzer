...
const CAUSE_COLORS: Record<string, string> = {
  ...
  "Adult Education": "bg-ma-mint/30 text-ma-gray-800",
  "AI & Technology": "bg-ma-sky/40 text-ma-gray-800",
  "Economic Mobility": "bg-ma-yellow/40 text-ma-gray-800",
  "Racial Equity & Inclusion": "bg-ma-purple/20 text-ma-gray-800",
  "Youth Development": "bg-ma-orange/20 text-ma-gray-800",
  "K-12 Education": "bg-ma-lavender/40 text-ma-gray-800",
  "Higher Education": "bg-ma-blue/15 text-ma-gray-800",
  Health: "bg-ma-pink/40 text-ma-gray-800",
  "Human Services": "bg-ma-pink/25 text-ma-gray-800",
  "Arts & Culture": "bg-ma-lavender/30 text-ma-gray-800",
  Environment: "bg-ma-green/15 text-ma-gray-800",
  "Community Development": "bg-ma-yellow/30 text-ma-gray-800",
  "Philanthropy & Intermediary": "bg-ma-gray-100 text-ma-gray-600",
  International: "bg-ma-sky/25 text-ma-gray-800",
    ...
    <div>
          ...
          <tbody>
            {displayed.map((grant, idx) => (
              ...
              >
                ...
                <td className="py-2.5 pr-4 font-medium text-ma-gray-900 max-w-xs truncate">
                  {grant.recipientName}
                </td>
                <td className="py-2.5 pr-4 text-right text-ma-gray-900 whitespace-nowrap font-medium">
      ...
      {grants.length > 15 && (
        <button
          ...
          className="mt-3 text-sm text-ma-teal hover:text-ma-gray-800 flex items-center gap-1 transition-colors font-medium"
        >
          {showAll ? (
